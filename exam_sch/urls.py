...
from exam_sch.views import user_table_create,subject_list,subject_detail,program_type_list,program_type_detail
...
from . import views
from exam_sch.views import semester_detail,semester_list,slot_list,slot_detail
...
router.register(r'Program_Type',views.program_type_list, basename = 'Program_type')
...
urlpatterns = [
    ...
    path('api/program_type_list/', views.program_type_list, name='program-type-list'),
    path('api/program_type_detail/<int:pk>/', views.program_type_detail, name='program-type-detail'),
